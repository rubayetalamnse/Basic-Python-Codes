...
for value in data.values():
    if value >= age:
        ...
        sum2+=value2
cal=sum1+sum2
res=((cal-19590)/19590)*100
print(int(res))"""

age = int(input())
new = old = 0 #initiating old & new revenue value

for i in data.values():   #to calculate old revenue value i.e. age>18 = 20 & age<18 = 5
    old += 5 if i < 18 else 20   
for j in data.values():   #to calculate new revenue value
    new += 5 if j < age else 20 #if value is less than age revenue +  5 else + 20
if age < 18:
